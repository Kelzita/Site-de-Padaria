...
<body>
    ...
    <div class="container">
        ...
        <form class="formulario-cadastro" method="POST" action="../php/cadastro_funcionario.php"
            ...
            <input type="text" id="cpf_funcionario" name="cpf_funcionario"
                placeholder="Digite o CPF (ex: 000.000.000-00)" maxlength="14">
