    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a href="?pagina=<?= $paginaAtual ?>&dataInicial=<?= $dataInicial ?>&dataFinal=<?= $dataFinal ?>&mostrarNumeros=<?= $mostrarNumeros ?>&detalhes=<?= $venda['id_comanda'] ?>" class="btn-detalhes" title="Ver detalhes">
