...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO funcionarios (nome_funcionario,cpf_funcionario, email_funcionario,telefone_funcionario,cep_funcionario,rua_funcionario,numero_funcionario,bairro_funcionario, cidade_funcionario,uf_funcionario,data_admissao,salario,id_funcao) VALUES (:nome_funcionario,:cpf_funcionario, :email_funcionario,:telefone_funcionario,:cep_funcionario,:rua_funcionario,:numero_funcionario,:bairro_funcionario, :cidade_funcionario,:uf_funcionario,:data_admissao,:salario,:id_funcao)";
